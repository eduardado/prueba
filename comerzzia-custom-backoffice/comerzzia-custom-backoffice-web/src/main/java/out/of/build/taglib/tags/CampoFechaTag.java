...
public class CampoFechaTag extends BodyTagSupport{
	...
	private String anchuraPorDefecto = "60px"; // Anchura (en pixels) por defecto del input de tipo fecha
	...
	public int doAfterBody() throws JspTagException {
		...
		try {
			...
			throw new JspTagException("doStartTag() - Excepción en la clase del tag CampoFechaTag: "+e.getMessage());
		}
	}
	...
	public int doEndTag() throws JspException {
		try {
			...
			String width = anchuraPorDefecto;
