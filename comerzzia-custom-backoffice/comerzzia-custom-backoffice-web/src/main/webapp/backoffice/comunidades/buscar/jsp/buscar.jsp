...
<jsp:useBean id="comunidad"
	class="com.comerzzia.bookerzzia.backoffice.persistence.comunidades.ComunidadBean"
	scope="request" />
<jsp:useBean id="paramBuscarComunidades"
	type="com.comerzzia.bookerzzia.backoffice.persistence.comunidades.ParametrosBuscarComunidadBean"
	scope="session" />
...
<body onload="inicio();">
	<cmz:main>
		<cmz:panelCMZ>
			<cmz:cabeceraPanelCMZ titulo="Mantenimiento de Comunidades Autónomas"
				icono="${permisos.accionMenu.icono}">
				<cmz:acciones numAccionesVisibles="1">
					<c:if test="${permisos.puedeAñadir}">
						<cmz:accionNuevoRegistro onclick="alta();"
							descripcion="Alta de una nueva Comunidad Autónoma" />
					</c:if>
			...
			<cmz:cuerpoPanelCMZ>
				<cmz:mensaje />
				<form id="frmDatos" name="frmDatos" action="comunidades"
					method="post">
										...
										<table cellpadding="2px" cellspacing="2px" border="0px">
											<tr>
												...
												<td><cmz:campoTexto id="codigo"
														valor="${paramBuscarComunidades.codigo}" anchura="100px"
														longitudMaxima="6" /></td>
											...
											<tr>
												...
												<td><cmz:campoTexto id="descripcion"
														valor="${paramBuscarComunidades.descripcion}"
														anchura="100px" longitudMaxima="20" /></td>
											</tr>
											<tr>
												<td><cmz:etiqueta titulo="Idioma" />:</td>
												<td><cmz:campoTexto id="idioma"
														valor="${paramBuscarComunidades.idioma}" anchura="100px"
