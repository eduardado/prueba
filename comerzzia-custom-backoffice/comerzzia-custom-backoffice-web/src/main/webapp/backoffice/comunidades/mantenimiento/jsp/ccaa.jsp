                           ...
                           <tr>
                              <td>
                                 <table cellpadding="2px" cellspacing="2px" border="0px">
                                    <tr>
                                       <td>
                                          <cmz:etiqueta titulo="Código" />:</td>
                                       <td>
                                          <cmz:campoTexto id="codigo" valor="${ccaa.codigo}"
                                             requerido="true" anchura="400px" longitudMaxima="6"
                                             editable="${ccaa.enInsercion}"
                                             soloLectura="${!ccaa.enInsercion}" />
                                       </td>
                                    </tr>
                                    <tr>
                                       <td>
                                          <cmz:etiqueta titulo="Descripción" />:</td>
                                       <td>
                                          <cmz:campoTexto id="descripcion"
                                             valor="${ccaa.descripcion}" requerido="true"
                                             anchura="400px" longitudMaxima="20"
                                             editable="${ccaa.enEdicion}"
                                             soloLectura="${!ccaa.enEdicion}" />
                                       </td>
                                    </tr>
                                    <tr>
                                       <td>
                                          <cmz:etiqueta titulo="Idioma" />:</td>
                                       <td>
                                          <cmz:campoTexto id="idioma" valor="${ccaa.idioma}"
