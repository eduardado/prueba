      ...
      <cmz:panelCMZ>
            ...
            <c:choose>
              <c:when test="${!lenguaje.enEdicion}">
                ...
                <c:if test="${permisos.puedeEditar}">
                  <cmz:accion icono="comun/images/iconos/i-edit.gif" onclick="editar();" titulo="Editar" descripcion="Editar País"></cmz:accion>
                </c:if>
                <c:if test="${permisos.puedeAñadir}">
                  <cmz:accionNuevoRegistro onclick="alta();" descripcion="Añadir un nuevo País"/>
                </c:if>
                <c:if test="${permisos.puedeEliminar}">
                  <cmz:accion icono="comun/images/iconos/i-cancel.gif" onclick="eliminar();" titulo="Eliminar" descripcion="Eliminar País"></cmz:accion>
                </c:if>
              </c:when>
              <c:otherwise>
        ...
        <cmz:cuerpoPanelCMZ>
          ...
          <form id="frmDatos" name="frmDatos" action="lenguajes" method="post">
            ...
            <input id="idObjeto" name="idObjeto" type="hidden" value="${lenguaje.codlengua}" />
            <input id="estadoObjeto" name="estadoObjeto" type="hidden" value="${lenguaje.estadoBean}" />
